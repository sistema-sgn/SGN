        ...
        <!-- Div 1 -->
          <div class="box box-primary">
            <div class="box-header">
              ...
              <h3 class="box-title">Formulario Empresa</h3>
              <!-- Minimizar -->
...
<form class="form-horizontal">
    <div class="form-group">
        <label class="control-label col-sm-2" for="empresaN"><strong>*</strong>Nombre:</label>
        <div class="col-sm-10">
          <div class="input-group">
             <span class="input-group-addon"><i class="fas fa-building"></i></span>
             <input type="text" onkeyup="" id="empresaN" autocomplete="off" class="form-control" maxlength="45" placeholder="Nombre de usuario">
          </div> 
        </div>
    </div>      
</form>

        ...
        <!-- Div 1 -->
          <div class="box box-primary">
            <div class="box-header">
              ...
              <h3 class="box-title">Formulario AFP</h3>
              <!-- Minimizar -->
...
<form class="form-horizontal">
    <div class="form-group">
        <label class="control-label col-sm-2" for="AFPN"><strong>*</strong>Nombre AFP:</label>
        <div class="col-sm-10">
          <div class="input-group">
             <span class="input-group-addon"><i class="fas fa-hospital-alt"></i></span>
             <input type="text" id="AFPN" autocomplete="off" class="form-control" maxlength="45" placeholder="Nombre de la AFP">
          </div> 
        </div>
    </div>      
</form>

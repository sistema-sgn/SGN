        ...
        <!-- Div 1 -->
          <div class="box box-primary">
            <div class="box-header">
              ...
              <h3 class="box-title">Formulario Salarios</h3>
              <!-- Minimizar -->
...
<form class="form-horizontal">
    <div class="form-group">
        <label class="control-label col-sm-2" for="salarioN"><strong>*</strong>Salario:</label>
        <div class="col-sm-10">
          <div class="input-group">
             <span class="input-group-addon"><i class="fas fa-dollar-sign"></i></span>
             <input type="text" onkeyup="" id="salarioN" autocomplete="off" class="form-control" maxlength="45" placeholder="Aproximado del salario">
          </div> 
        </div>
    </div>      
</form>

        ...
        <!-- Div 1 -->
          <div class="box box-primary">
            <div class="box-header">
              ...
              <h3 class="box-title">Formulario de Cargos</h3>
              <!-- Minimizar -->
...
<form class="form-horizontal">
    <div class="form-group">
        <label class="control-label col-sm-2" for="CargoN"><strong>*</strong>Nombre del Cargo:</label>
        <div class="col-sm-10">
          <div class="input-group">
             <span class="input-group-addon"><i class="fas fa-hospital-alt"></i></span>
             <input type="text" id="CargoN" autocomplete="off" class="form-control" maxlength="60" placeholder="Nombre del Cargo">
          </div> 
        </div>
    </div>      
</form>

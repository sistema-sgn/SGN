        ...
        <!-- Div 1 -->
          <div class="box box-primary">
            <div class="box-header">
              ...
              <h3 class="box-title">Formulario de Grado de escolaridad</h3>
              <!-- Minimizar -->
...
<form class="form-horizontal">
    <div class="form-group">
        <label class="control-label col-sm-2" for="gradoEscolaridadN"><strong>*</strong>Grado escolaridad:</label>
        <div class="col-sm-10">
          <div class="input-group">
             <span class="input-group-addon"><i class="fas fa-graduation-cap"></i></span>
             <input type="text" id="gradoEscolaridadN" autocomplete="off" class="form-control" maxlength="20" placeholder="Nombre del Grado de escolaridad">
          </div> 
        </div>
    </div>      
</form>

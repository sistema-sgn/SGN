        ...
        <!-- Div 1 -->
          <div class="box box-primary">
            <div class="box-header">
              ...
              <h3 class="box-title">Formulario de Horario de trabajo</h3>
              <!-- Minimizar -->
...
<form class="form-horizontal">
    <div class="form-group">
        <label class="control-label col-sm-2" for="horarioLaboralN"><strong>*</strong>Horario:</label>
        <div class="col-sm-10">
          <div class="input-group">
             <span class="input-group-addon"><i class="fas fa-clock"></i></span>
             <input type="text" id="horarioLaboralN" autocomplete="off" class="form-control" maxlength="20" placeholder="Horario de trabajo">
          </div> 
        </div>
    </div>      
</form>

        ...
        <!-- Div 1 -->
          <div class="box box-primary">
            <div class="box-header">
              ...
              <h3 class="box-title">Formulario Auxilio</h3>
              <!-- Minimizar -->
...
<form class="form-horizontal">
    <div class="form-group">
        <label class="control-label col-sm-2" for="AuxilioN"><strong>*</strong>Auxilio:</label>
        <div class="col-sm-10">
          <div class="input-group">
             <span class="input-group-addon"><i class="fas fa-user-plus"></i></span>
             <input type="text" onkeyup="" id="AuxilioN" autocomplete="off" class="form-control" maxlength="45" placeholder="Nombre del auxilio">
          </div> 
        </div>
    </div>      
</form>

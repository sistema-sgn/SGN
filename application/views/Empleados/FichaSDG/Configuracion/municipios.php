        ...
        <!-- Div 1 -->
          <div class="box box-primary">
            <div class="box-header">
              ...
              <h3 class="box-title">Formulario de Municipios</h3>
              <!-- Minimizar -->
...
<form class="form-horizontal">
    <div class="form-group">
        <label class="control-label col-sm-2" for="municipioN"><strong>*</strong>Municipio: </label>
        <div class="col-sm-10">
          <div class="input-group">
             <span class="input-group-addon"><i class="fas fa-globe"></i></span>
             <input type="text" id="municipioN" autocomplete="off" class="form-control" maxlength="20" placeholder="Nombre del Municipio">
          </div> 
        </div>
    </div>      
</form>

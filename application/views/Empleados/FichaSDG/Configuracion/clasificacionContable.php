        ...
        <!-- Div 1 -->
          <div class="box box-primary">
            <div class="box-header">
              ...
              <h3 class="box-title">Formulario Clasificación Contables</h3>
              <!-- Minimizar -->
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
          <div class="input-group">
             ...
             <input type="text" onkeyup="" id="clasificacionContable" autocomplete="off" class="form-control" maxlength="45" placeholder="Nombre de la clasificacion contable">
          </div> 
        </div>
    </div>      
</form>

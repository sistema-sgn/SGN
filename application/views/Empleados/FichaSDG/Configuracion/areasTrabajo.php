        ...
        <!-- Div 1 -->
          <div class="box box-primary">
            <div class="box-header">
              ...
              <h3 class="box-title">Formulario de Áreas de Trabajo</h3>
              <!-- Minimizar -->
...
<form class="form-horizontal">
    <div class="form-group">
        <label class="control-label col-sm-2" for="areaLaboralN"><strong>*</strong>Área de Trabajo:</label>
        <div class="col-sm-10">
          <div class="input-group">
             <span class="input-group-addon"><i class="fas fa-briefcase"></i></span>
             <input type="text" id="areaLaboralN" autocomplete="off" class="form-control" maxlength="45" placeholder="Área de trabajo">
          </div> 
        </div>
    </div>      
</form>

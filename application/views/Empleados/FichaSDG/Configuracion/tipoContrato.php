        ...
        <!-- Div 1 -->
          <div class="box box-primary">
            <div class="box-header">
              ...
              <h3 class="box-title">Formulario de Tipo de Contrato</h3>
              <!-- Minimizar -->
...
<form class="form-horizontal">
    <div class="form-group">
        <label class="control-label col-sm-2" for="TipoContratoN"><strong>*</strong>Tipo de contrato:</label>
        <div class="col-sm-10">
          <div class="input-group">
             <span class="input-group-addon"><i class="fas fa-file"></i></span>
             <input type="text" id="TipoContratoN" autocomplete="off" class="form-control" maxlength="20" placeholder="Tipo de contrato">
          </div> 
        </div>
    </div>      
</form>

        ...
        <!-- Div 1 -->
          <div class="box box-primary">
            <div class="box-header">
              ...
              <h3 class="box-title">Formulario de Actividades en el Tiempo Libre</h3>
              <!-- Minimizar -->
...
<form class="form-horizontal">
    <div class="form-group">
        <label class="control-label col-sm-2" for="aTiempoLibreN"><strong>*</strong>A.Tiempo Libre:</label>
        <div class="col-sm-10">
          <div class="input-group">
             <span class="input-group-addon"><i class="fas fa-clock"></i></span>
             <input type="text" id="aTiempoLibreN" autocomplete="off" class="form-control" maxlength="45" placeholder="Actividad en el tiempo libre">
          </div> 
        </div>
    </div>      
</form>
